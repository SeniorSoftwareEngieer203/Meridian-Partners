      ...
      <Container className="relative">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <AnimatedSection delay={0.1}>
            <SectionImage
              src={siteImages.friendAmericanSupport}
              alt="Friend American helping coordinate payments and income for foreign developers"
              caption="Information, environments, and payments — handled by Friend Americans."
              imageClassName="object-cover object-center"
              className="[&_figcaption]:text-white/60"
            />
          </AnimatedSection>
        </div>

        <StaggerContainer className="mt-12 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
